...
-- Template Updates
UPDATE `creature_template` SET `speed_walk`= 1, `flags_extra`=1, `ScriptName`='boss_ascendants'             WHERE  `entry`=43686;
UPDATE `creature_template` SET `speed_walk`= 1, `flags_extra`=1, `ScriptName`='boss_ascendants'             WHERE  `entry`=43687;
UPDATE `creature_template` SET `speed_walk`= 1, `flags_extra`=1, `ScriptName`='boss_ascendants'             WHERE  `entry`=43688;
UPDATE `creature_template` SET `speed_walk`= 1, `flags_extra`=1, `ScriptName`='boss_ascendants'             WHERE  `entry`=43689;
...
UPDATE `creature_template` SET `modelid1`= 11686, `flags_extra`=1, `ScriptName`='npc_council_violent_cyclone' WHERE  `entry`=44747;
