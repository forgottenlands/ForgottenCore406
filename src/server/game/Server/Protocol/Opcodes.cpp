...
void InitOpcodeTable() {
    ...
    OPCODE( CMSG_REQUEST_RATED_BG_INFO, STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
            &WorldSession::Handle_NULL);
    OPCODE( CMSG_REQUEST_PVP_OPTIONS_ENABLED, STATUS_LOGGEDIN,
            PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
