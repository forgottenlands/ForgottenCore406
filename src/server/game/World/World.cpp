...
void World::LoadConfigSettings(bool reload)
{
    ...
    SetMotd(sConfig->GetStringDefault("Motd", "Welcome to a ArkCORE server."));
    ...
    rate_values[RATE_XP_KILL_ALLY]       = sConfig->GetFloatDefault("Rate.XP.Kill.Ally", 1.0f);
    ...
    rate_values[RATE_XP_QUEST_ALLY]      = sConfig->GetFloatDefault("Rate.XP.Quest.Ally", 1.0f);
    ...
    rate_values[RATE_REPUTATION_GAIN_ALLY] = sConfig->GetFloatDefault("Rate.Reputation.Gain.Ally", 1.0f);
