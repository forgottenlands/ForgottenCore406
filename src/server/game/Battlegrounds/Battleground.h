...
{
    BG_REWARD_WINNER_HONOR_FIRST    = 130 * 2,
    BG_REWARD_WINNER_ARENA_FIRST    = 25 * 2,
    BG_REWARD_WINNER_HONOR_LAST     = 70 * 2,
    BG_REWARD_WINNER_ARENA_LAST     = 0,
    BG_REWARD_LOSER_HONOR_FIRST    = 30 * 2,
    BG_REWARD_LOSER_HONOR_LAST     = 30 * 2
};
