    ...
    else
    {
        switch (getClass())
        {
            ...
            case CLASS_DRUID:
            {
                ...
                {
                    case FORM_CAT:
                        val2 = (getLevel() * 3.0f) +  (GetStat(STAT_STRENGTH) * 2.0f - 20.0f) + (GetStat(STAT_AGILITY) * 2.0f - 20.0f);
                    ...
                    case FORM_MOONKIN:
                        ...
                        break;
                    default:
                        val2 = (getLevel() * 2.0f) + (GetStat(STAT_STRENGTH) * 2.0f - 20.0f);
                        break;
                }
                break;
            }
