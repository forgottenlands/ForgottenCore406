...
public:
    ...
    virtual void OnPacketSend(WorldSocket* /*socket*/,
            WorldPacket& /*packet*/) {
    }

    // Called when a (valid) packet is received by a client. The packet object is a copy of the original packet, so
    // reading and modifying it is safe.
    virtual void OnPacketReceive(WorldSocket* /*socket*/,
            WorldPacket& /*packet*/) {
    }
    ...
    virtual void OnUnknownPacketReceive(WorldSocket* /*socket*/,
            WorldPacket& /*packet*/) {
    }
};
...
public:
    ...
    virtual void OnHonorCalculation(float& /*honor*/, uint8 /*level*/,
            float /*multiplier*/) {
    }
    ...
    virtual void OnColorCodeCalculation(XPColorChar& /*color*/,
            uint8 /*playerLevel*/, uint8 /*mobLevel*/) {
    }
    ...
    virtual void OnBaseGainCalculation(uint32& /*gain*/, uint8 /*playerLevel*/,
            uint8 /*mobLevel*/, ContentLevels /*content*/) {
    }

    // Called after calculating experience gain.
    virtual void OnGainCalculation(uint32& /*gain*/, Player* /*player*/,
            Unit* /*unit*/) {
    }

    // Called when calculating the experience rate for group experience.
    virtual void OnGroupRateCalculation(float& /*rate*/, uint32 /*count*/,
            bool /*isRaid*/) {
    }
};
...
public:
    ...
    virtual void OnLoadGridMap(TMap* /*map*/, GridMap* /*gmap*/, uint32 /*gx*/,
            uint32 /*gy*/) {
    }

    // Called when a grid map is unloaded.
    virtual void OnUnloadGridMap(TMap* /*map*/, GridMap* /*gmap*/,
            uint32 /*gx*/, uint32 /*gy*/) {
    }
...
public:
    ...
    virtual bool OnDummyEffect(Unit* /*caster*/, uint32 /*spellId*/,
            SpellEffIndex /*effIndex*/, Item* /*target*/) {
        return false;
    }

    // Called when a player accepts a quest from the item.
    virtual bool OnQuestAccept(Player* /*player*/, Item* /*item*/,
            Quest const* /*quest*/) {
        return false;
    }

    // Called when a player uses the item.
    virtual bool OnUse(Player* /*player*/, Item* /*item*/,
            SpellCastTargets const& /*targets*/) {
        return false;
    }

    // Called when the item expires (is destroyed).
    virtual bool OnExpire(Player* /*player*/, ItemPrototype const* /*proto*/) {
        return false;
    }
};
...
public:
    ...
    virtual bool OnGossipSelect(Player* /*player*/, Creature* /*creature*/,
            uint32 /*sender*/, uint32 /*action*/) {
        return false;
    }

    // Called when a player selects a gossip with a code in the creature's gossip menu.
    virtual bool OnGossipSelectCode(Player* /*player*/, Creature* /*creature*/,
            uint32 /*sender*/, uint32 /*action*/, const char* /*code*/) {
        return false;
    }

    // Called when a player accepts a quest from the creature.
    virtual bool OnQuestAccept(Player* /*player*/, Creature* /*creature*/,
            Quest const* /*quest*/) {
        return false;
    }

    // Called when a player selects a quest in the creature's quest menu.
    virtual bool OnQuestSelect(Player* /*player*/, Creature* /*creature*/,
            Quest const* /*quest*/) {
        return false;
    }

    // Called when a player completes a quest with the creature.
    virtual bool OnQuestComplete(Player* /*player*/, Creature* /*creature*/,
            Quest const* /*quest*/) {
        return false;
    }

    // Called when a player selects a quest reward.
    virtual bool OnQuestReward(Player* /*player*/, Creature* /*creature*/,
...
public:
    ...
    virtual bool OnGossipSelect(Player* /*player*/, GameObject* /*go*/,
            uint32 /*sender*/, uint32 /*action*/) {
        return false;
    }

    // Called when a player selects a gossip with a code in the gameobject's gossip menu.
    virtual bool OnGossipSelectCode(Player* /*player*/, GameObject* /*go*/,
            uint32 /*sender*/, uint32 /*action*/, const char* /*code*/) {
        return false;
    }

    // Called when a player accepts a quest from the gameobject.
    virtual bool OnQuestAccept(Player* /*player*/, GameObject* /*go*/,
            Quest const* /*quest*/) {
        return false;
    }

    // Called when a player selects a quest reward.
    virtual bool OnQuestReward(Player* /*player*/, GameObject* /*go*/,
            Quest const* /*quest*/, uint32 /*opt*/) {
        return false;
    }
...
public:
    ...
    virtual bool OnTrigger(Player* /*player*/,
...
public:
    ...
    virtual void OnChange(Weather* /*weather*/, WeatherState /*state*/,
            float /*grade*/) {
    }
};
...
public:
    ...
    virtual bool OnConditionCheck(Condition* /*condition*/, Player* /*player*/,
            Unit* /*invoker*/) {
        return true;
    }
};
...
public:
    ...
    virtual void OnAddPassenger(Vehicle* /*veh*/, Unit* /*passenger*/,
            int8 /*seatId*/) {
    }
...
public:
    ...
    virtual void OnRemovePassenger(Transport* /*transport*/,
            Player* /*player*/) {
    }
...
public:
    ...
    virtual void OnReputationChange(Player* /*player*/, uint32 /*factionID*/,
    ...
    virtual void OnDuelEnd(Player* /*winner*/, Player* /*looser*/,
            DuelCompleteType /*type*/) {
    }

    // The following methods are called when a player sends a chat message
    virtual void OnChat(Player* /*player*/, uint32 /*type*/, uint32 /*lang*/,
            std::string /*msg*/) {
    }
    virtual void OnChat(Player* /*player*/, uint32 /*type*/, uint32 /*lang*/,
    ...
    virtual void OnTextEmote(Player* /*player*/, uint32 /*text_emote*/,
    ...
    virtual void OnBindToInstance(Player* /*player*/, Difficulty /*difficulty*/,
    ...
    virtual void OnSpellCastWithProto(Player* /*player*/,
            SpellEntry const* /*spellProto*/) {
    }
...
public:
    ...
    virtual void OnAddMember(Guild* /*guild*/, Player* /*player*/,
            uint8& /*plRank*/) {
    }
    virtual void OnRemoveMember(Guild* /*guild*/, Player* /*player*/,
            bool /*isDisbanding*/, bool /*isKicked*/) {
    }
    virtual void OnMOTDChanged(Guild* /*guild*/,
            const std::string& /*newMotd*/) {
    }
    virtual void OnInfoChanged(Guild* /*guild*/,
            const std::string& /*newInfo*/) {
    }
    virtual void OnCreate(Guild* /*guild*/, Player* /*leader*/,
    ...
    virtual void OnMemberDepositMoney(Guild* /*guild*/, Player* /*player*/,
            uint32& /*amount*/) {
    }
    virtual void OnItemMove(Guild* /*guild*/, Player* /*player*/,
            Item* /*pItem*/, bool /*isSrcBank*/, uint8 /*srcContainer*/,
            uint8 /*srcSlotId*/, bool /*isDestBank*/, uint8 /*destContainer*/,
            uint8 /*destSlotId*/) {
    }
    virtual void OnEvent(Guild* /*guild*/, uint8 /*eventType*/,
            uint32 /*playerGuid1*/, uint32 /*playerGuid2*/, uint8 /*newRank*/) {
    }
    virtual void OnBankEvent(Guild* /*guild*/, uint8 /*eventType*/,
            uint8 /*tabId*/, uint32 /*playerGuid*/, uint32 /*itemOrMoney*/,
...
public:
    ...
    virtual void OnRemoveMember(Group* /*group*/, uint64 /*guid*/,
            RemoveMethod& /*method*/, uint64 /*kicker*/,
            const char* /*reason*/) {
    }
    virtual void OnChangeLeader(Group* /*group*/, uint64 /*newLeaderGuid*/,
...
public:
    ...
    void CreateSpellScripts(uint32 spell_id,
            std::list<SpellScript*>& script_vector);
    void CreateAuraScripts(uint32 spell_id,
            std::list<AuraScript*>& script_vector);
    void CreateSpellScriptLoaders(
            uint32 spell_id,
            std::vector<
                    std::pair<SpellScriptLoader*,
                            std::multimap<uint32, uint32>::iterator> >& script_vector);
...
public:
    ...
    bool OnDummyEffect(Unit* caster, uint32 spellId, SpellEffIndex effIndex,
            Item* target);
...
public:
    ...
    bool OnGossipSelect(Player* player, GameObject* go, uint32 sender,
            uint32 action);
    bool OnGossipSelectCode(Player* player, GameObject* go, uint32 sender,
            uint32 action, const char* code);
...
public:
    ...
    bool OnCriteriaCheck(AchievementCriteriaData const* data, Player* source,
            Unit* target);
...
public:
    ...
    void OnPlayerReputationChange(Player *player, uint32 factionID,
            int32& standing, bool incremental);
    ...
    void OnPlayerTextEmote(Player* player, uint32 text_emote, uint32 emoteNum,
            uint64 guid);
...
public:
    ...
    void OnGuildMemberWitdrawMoney(Guild* guild, Player* player, uint32 &amount,
            bool isRepair);
    void OnGuildMemberDepositMoney(Guild* guild, Player* player,
            uint32 &amount);
    void OnGuildItemMove(Guild* guild, Player* player, Item* pItem,
            bool isSrcBank, uint8 srcContainer, uint8 srcSlotId,
            bool isDestBank, uint8 destContainer, uint8 destSlotId);
    void OnGuildEvent(Guild* guild, uint8 eventType, uint32 playerGuid1,
            uint32 playerGuid2, uint8 newRank);
    void OnGuildBankEvent(Guild* guild, uint8 eventType, uint8 tabId,
...
public:
    ...
    void OnGroupRemoveMember(Group* group, uint64 guid, RemoveMethod method,
            uint64 kicker, const char* reason);
    void OnGroupChangeLeader(Group* group, uint64 newLeaderGuid,
            uint64 oldLeaderGuid);
