            ...
            else
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    ...
                    case EVENT_SAY:
                        ...
                        else if (phase == 2)
                        {
                            ...
                            case 3:
                                ...
                                me->SetVisible(true);
                                me->CastSpell(me, SPELL_EXPLOSION_VISUAL);
                                break;
                            case 4:
                    ...
                    case EVENT_GLACIATE:
                        ...
                        {
                            ascendant[1]->CastSpell(ascendant[1]->getVictim(), SPELL_GLACIATE);
                    ...
                    case EVENT_HYDRO_LANCE:
                        if (Unit *pTarget = SelectTarget(SELECT_TARGET_RANDOM, 0)){
                            if (ascendant[1] != NULL){
                                ascendant[1]->CastSpell(ascendant[1], SPELL_HYDRO_LANCE);
                            }
                        }
                    ...
                    case EVENT_WATER_BOMB:
                        if (ascendant[1])
                        {
                            ascendant[1]->CastSpell(ascendant[1]->getVictim(), SPELL_WATER_BOMB);
                        }
                    ...
                    case EVENT_AEGIS_OF_FLAME:
                        if (ascendant[0] != NULL)
                        {
                            ascendant[0]->CastSpell(ascendant[0], SPELL_AEGIS_OF_FLAME);
                    ...
                    case EVENT_RISING_FLAMES:
                        if (ascendant[0] != NULL)
                        {
                            ascendant[0]->CastSpell(ascendant[0], SPELL_RISING_FLAMES);
                    ...
                    case EVENT_INFERNO_LEAP:
                        if (Unit *pTarget = SelectTarget(SELECT_TARGET_RANDOM, 0, -10.0f)){
                            if (ascendant[0] != NULL){
                                ascendant[0]->CastSpell(ascendant[0], SPELL_INFERNO_LEAP);
                    ...
                    case EVENT_INFERNO_RUSH:
                        if (Unit* pTarget = ascendant[0]->getVictim()){
                            if (ascendant[0] != NULL){
                                ascendant[0]->CastSpell(pTarget, SPELL_INFERNO_RUSH);
                    ...
                    case EVENT_FLAME_TORRENT:
                        if (Unit *pTarget = ascendant[0]->getVictim())
                        {
                            if (ascendant[0] != NULL)
                            {
                                ascendant[0]->CastSpell(pTarget, SPELL_FLAME_TORRENT);
                            }
                        }
                    ...
                    case EVENT_LIGHTNING_ROD:
                        ...
                        else if (Unit *pTarget = SelectTarget(SELECT_TARGET_RANDOM, 0, 0))
                    ...
                    case EVENT_CHAIN_LIGHTNING:
                        ...
                        {//25 man mode, 3 targets
                            for (int i=0; i<3; i++)
                            {
                                ...
                                {
                                    ascendant[2]->CastSpell(chaintargets[i], SPELL_CHAIN_LIGHTNING);
                                }
                            }
                        }
                        else
                        {// 10 man mode, 1 target
                            ...
                            {
                                ascendant[2]->CastSpell(chaintargets[0], SPELL_CHAIN_LIGHTNING);
                            }
                        }
                    ...
                    case EVENT_DISPERSION:
                        ...
                        if (ascendant[2] != NULL)
                        {
                            ascendant[2]->CastSpell(ascendant[2], SPELL_DISPERSION);
                        }
                    ...
                    case EVENT_LIGHTNING_BLAST:
                        ...
                        {
                            ascendant[2]->CastSpell(prevtarget, SPELL_LIGHTNING_BLAST);
                        }
                        ascendant[2]->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_NOT_SELECTABLE);
                        ascendant[2]->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_NOT_SELECTABLE);
                    ...
                    case EVENT_CYCLONE:
                        if (ascendant[2] != NULL)
                        {
                            ascendant[2]->CastSpell(ascendant[2], SPELL_CALL_WINDS);
                    ...
                    case EVENT_THUNDERSHOCK:
                        if (ascendant[2] != NULL)
                        {
                            ascendant[2]->CastSpell(ascendant[2], SPELL_THUNDERSHOCK);
                        }
                        events.ScheduleEvent(EVENT_THUNDERSHOCK, 60000);
                        return;
                        break;
                    ...
                    case EVENT_QUAKE:
                        if (ascendant[3] != NULL)
                        {
                            ascendant[3]->CastSpell(ascendant[2], SPELL_QUAKE);
                    ...
                    case EVENT_HARDEN_SKIN:
                        if (ascendant[3] != NULL)
                        {
                            ascendant[3]->CastSpell(ascendant[2], SPELL_HARDEN_SKIN);
                        }
                    ...
                    case EVENT_ERUPTION:
                        if (ascendant[3] != NULL)
                        {
                            ascendant[3]->CastSpell(ascendant[3], SPELL_ERUPTION);
                        }
                    ...
                    case EVENT_ZAP:
                        for (int i=0; i<zap; i++)
                        {
                            if (Unit *pTarget = SelectTarget(SELECT_TARGET_RANDOM, 0, 0))
                            {
                    ...
                    case EVENT_GRAVITY_CRUSH:
                        ...
                        me->CastSpell(me, SPELL_GRAVITY_CRUSH);
                    ...
                    case EVENT_LAVA_SEED:
                        me->CastSpell(me, SPELL_LAVA_SEED);
                        events.ScheduleEvent(EVENT_LAVA_SEED, 12000);
                        return;
                        break;
                    //##############
                    ...
                    case EVENT_OVERLOAD_AND_CORE:
                        if (Unit *pTarget = SelectTarget(SELECT_TARGET_RANDOM, 0, 0))
                        {
                            ...
                            if (Unit *rTarget = SelectTarget(SELECT_TARGET_RANDOM, 0, 0))
                            {
                                if (pTarget->GetGUID() == rTarget->GetGUID())
                                    rTarget = SelectTarget(SELECT_TARGET_RANDOM, 0, 0);
                                if (pTarget->GetGUID() == rTarget->GetGUID())
                                    rTarget = SelectTarget(SELECT_TARGET_RANDOM, 0, 0);
                    ...
                    case EVENT_FLAMESTRIKE_AND_ORB:
                        if (Unit *pTarget = SelectTarget(SELECT_TARGET_FARTHEST, 0, 0))
                        {
                            ...
                            if (Unit *rTarget = SelectTarget(SELECT_TARGET_NEAREST, 0, 0))
                            {
                                //if the same target get chosen four times in a row, nevermind, its his/her fate (or maybe the only one left)
        ...
        void DoAction(const int32 action)
        {
            ...
            case COUNCIL_PHASE_2:
                ...
                {//here will summon the elementium monstrosity
                    ...
                    ascendant[0]->CastSpell(ascendant[0], SPELL_TELEPORT_VISUAL);
                    ascendant[1]->CastSpell(ascendant[0], SPELL_TELEPORT_VISUAL);
                    ascendant[2]->CastSpell(ascendant[0], SPELL_TELEPORT_VISUAL);
                    ascendant[3]->CastSpell(ascendant[0], SPELL_TELEPORT_VISUAL);
...
public:
    ...
    struct boss_ascendantsAI : public ScriptedAI
    {
        ...
        {
            if (Creature* monstrosity = ObjectAccessor::GetCreature(*me,instance->GetData64(BOSS_ELEMENTIUM)))
        ...
        void Reset()
        {
            if (Creature* elementium = ObjectAccessor::GetCreature(*me,instance->GetData64(BOSS_ELEMENTIUM)))
...
public: npc_frozen_orb_council() : CreatureScript("npc_frozen_orb_council") { }
    ...
    struct npc_frozen_orb_councilAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            chase = SelectTarget(SELECT_TARGET_RANDOM, -10, 0);
            if (chase)
            {
        ...
        void UpdateAI(const uint32 diff)
        {
            if (checkTimer <= diff)
            {
                ...
                {
                    me->CastSpell(me, SPELL_FROZEN_ORB_GLACIATE);
                    dying=true;
                }
...
{
public: npc_gravity_well() : CreatureScript("npc_gravity_well") { }
...
public: npc_water_bomb() : CreatureScript("npc_water_bomb") {}
	...
	struct npc_water_bombAI: public ScriptedAI 
    {
		...
		void InitializeAI() 
        {
            ...
            feludius->CastSpell(me, SPELL_WATER_BOMB_VISUAL);
			me->SetReactState(REACT_PASSIVE);
		...
		void UpdateAI(const uint32 diff) 
        {
			...
			if (timer <= diff) 
            {
                me->CastSpell(me, SPELL_WATER_BOMB_EXPLO);
            }
            else
				timer -= diff;
		}
...
public: npc_lava_seed() : CreatureScript("npc_lava_seed") {}
	...
	struct npc_lava_seedAI: public ScriptedAI 
    {
		...
		void InitializeAI() 
        {
            ...
            me->GetMotionMaster()->MovePoint(0,me->GetPositionX(),me->GetPositionY(), me->GetPositionZ()-35, me->GetOrientation());
		}
		...
		void UpdateAI(const uint32 diff) 
        {
			...
			if (timer <= diff) 
            {
                me->CastSpell(me, SPELL_LAVA_PLUME);
            }
            else
				timer -= diff;
		}
...
class spell_water_bomb : public SpellScriptLoader
{
    public:
        spell_water_bomb() : SpellScriptLoader("spell_water_bomb") { }

        class spell_water_bomb_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_water_bomb_SpellScript);
            ...
            void HandleBomb()
            {
                ...
                for(uint32 i=0; i<num; i++)
                {
                    ...
                    caster->SummonCreature(NPC_WATER_BOMB, 
                                           caster->GetPositionX() + dist*cos(dir),
                                           caster->GetPositionY() + dist*cos(dir), 
                                           caster->GetPositionZ(),
            ...
            void Register()
            {
                OnCast += SpellCastFn(spell_water_bomb_SpellScript::HandleBomb);
            }
        ...
        SpellScript* GetSpellScript() const
        {
            return new spell_water_bomb_SpellScript();
        }
};

class spell_lava_seed : public SpellScriptLoader
{
    public:
        spell_lava_seed() : SpellScriptLoader("spell_lava_seed") { }

        class spell_lava_seed_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_lava_seed_SpellScript);
            ...
            void HandleLavaSeed()
            {
                ...
                for(uint32 i=0; i<num; i++)
                {
                    ...
                    caster->SummonCreature(NPC_LAVA_SEED, 
                                           caster->GetPositionX() + dist*cos(dir),
                                           caster->GetPositionY() + dist*cos(dir), 
                                           caster->GetPositionZ()+35,
                                           caster->GetOrientation());
                }
            }
            ...
            void Register()
            {
                OnCast += SpellCastFn(spell_lava_seed_SpellScript::HandleLavaSeed);
            }
        ...
        SpellScript* GetSpellScript() const
        {
            return new spell_lava_seed_SpellScript();
        }
};
...
class spell_rising_flames : public SpellScriptLoader
{
    public:
        ...
        class spell_rising_flames_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnCast += SpellCastFn(spell_rising_flames_SpellScript::HandleRisingFlames);
            }
